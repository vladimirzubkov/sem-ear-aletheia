...
![Use-Case Diagram](Documentation\plantuml\plantuml-output\use_case_diagram_cp2.png)

#### 6.2 Diagram tříd (Class Diagram)
![Class Diagram – zjednodušená verze](Documentation\plantuml\plantuml-output\class_diagram_cp2.png)

#### 6.3 Diagram datových entit (ERD)
![Datový model – tabulky a relace](Documentation\plantuml\plantuml-output\data_entity_diagram_cp2.png)
